...
//    private TypedValue typedValue;
    ...
    public void setProgressColor(int mProgessColor) {
...
//        typedValue = new TypedValue();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paintText.setColor(mProgessColor);
        ...
        canvas.drawText(unit, mWidth / 2, mHeight / 2 + radius / 3 + textBaseLineOffset, paintText);
        /*绘制百分比*/
